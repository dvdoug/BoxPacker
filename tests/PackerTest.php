...
class PackerTest extends TestCase
{
    ...
    public function testStrictItemOrdering(): void
    {
        ...
        self::assertEquals('Item #2', $box2Items[0]->getDescription());
        self::assertEquals('Item #1', $box2Items[1]->getDescription());
        self::assertEquals('Item #1', $box2Items[2]->getDescription());
        self::assertEquals('Item #1', $box2Items[3]->getDescription());
        self::assertEquals('Item #1', $box2Items[4]->getDescription());
        self::assertEquals('Item #1', $box2Items[5]->getDescription());
        self::assertEquals('Item #1', $box2Items[6]->getDescription());
        self::assertEquals('Item #1', $box2Items[7]->getDescription());
        self::assertEquals('Item #1', $box2Items[8]->getDescription());
        self::assertEquals('Item #1', $box2Items[9]->getDescription());
        self::assertEquals('Item #1', $box2Items[10]->getDescription());
        self::assertEquals('Item #1', $box2Items[11]->getDescription());
        self::assertEquals('Item #1', $box2Items[12]->getDescription());
        self::assertEquals('Item #1', $box2Items[13]->getDescription());
        self::assertEquals('Item #1', $box2Items[14]->getDescription());
        self::assertEquals('Item #1', $box2Items[15]->getDescription());
        self::assertEquals('Item #1', $box2Items[16]->getDescription());
        self::assertEquals('Item #1', $box2Items[17]->getDescription());
