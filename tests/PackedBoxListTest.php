...
class PackedBoxListTest extends TestCase
{
    ...
    public function testVisualisationURL(): void
    {
        ...
        self::assertEquals('https://boxpacker.io/en/master/visualiser.html?packing={"items":[["Item",4,10,10]],"boxes":[["Box",10,10,20,[[0,0,0,0,4,10,10]]]]}', $packedBoxList->generateVisualisationURL());
    }
}
